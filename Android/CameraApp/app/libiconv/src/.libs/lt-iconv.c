...
/* ./.libs/lt-iconv.c - temporary wrapper executable for .libs/iconv.exe
   Generated by libtool (GNU libtool) 2.4

   The iconv program cannot be directly executed until all the libtool
...
const char * LIB_PATH_VALUE   = "C:\\MinGW\\msys\\1.0\\local\\lib;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "C:\\MinGW\\msys\\1.0\\local\\lib;C:\\MinGW\\msys\\1.0\\local\\bin;";
const char * TARGET_PROGRAM_NAME = "iconv.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# iconv - temporary wrapper script for .libs/iconv.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4\n", f);
  fputs ("#\n", f);
  fputs ("# The iconv program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("  notinst_deplibs=' /usr/local/lib/libiconv.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"iconv.exe:iconv:${LINENO}: libtool wrapper (GNU libtool) 2.4\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"iconv.exe:iconv:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"iconv.exe:iconv:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
  ...
  fputs ("    PATH=/usr/local/lib:/usr/local/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/usr/local/lib:$PATH\"\n", f);
  fputs ("\n", f);
