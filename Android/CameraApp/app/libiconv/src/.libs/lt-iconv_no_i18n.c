...
/* ./.libs/lt-iconv_no_i18n.c - temporary wrapper executable for .libs/iconv_no_i18n.exe
...
const char * LIB_PATH_VALUE   = "c:\\Users\\Hakan\\AndroidStudioProjects\\CameraApp\\app\\libiconv\\lib\\.libs;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "c:\\Users\\Hakan\\AndroidStudioProjects\\CameraApp\\app\\libiconv\\lib\\.libs;C:\\MinGW\\msys\\1.0\\local\\lib;C:\\MinGW\\msys\\1.0\\local\\bin;";
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# iconv_no_i18n - temporary wrapper script for .libs/iconv_no_i18n.exe\n", f);
  ...
  fputs ("    echo \"iconv_no_i18n.exe:iconv_no_i18n:${LINENO}: libtool wrapper (GNU libtool) 2.4\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"iconv_no_i18n.exe:iconv_no_i18n:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"iconv_no_i18n.exe:iconv_no_i18n:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
  ...
  fputs ("\n", f);
  fputs ("  program='iconv_no_i18n.exe'\n", f);
  ...
  fputs ("    PATH=/c/Users/Hakan/AndroidStudioProjects/CameraApp/app/libiconv/lib/.libs:/usr/local/lib:/usr/local/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/c/Users/Hakan/AndroidStudioProjects/CameraApp/app/libiconv/lib/.libs:$PATH\"\n", f);
  fputs ("\n", f);
